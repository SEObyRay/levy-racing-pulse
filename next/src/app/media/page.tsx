...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://levyopbergen.nl/media",
  },
  openGraph: {
    title: "Media & Pers | Levy Opbergen",
    description: "Vind alle pers- en mediakits van Levy Opbergen.",
    url: "https://levyopbergen.nl/media",
  },
};
...
const mediaKits = [
  ...
  },
  {
    ...
    description: "Quotes van Levy, zijn coach en teammanager. Te gebruiken voor media-artikelen en podcasts.",
    cta: {
      label: "Aanvragen",
      ...
      <div className="container mx-auto px-4 max-w-5xl space-y-16">
        <section className="text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Vind snel alle assets rondom Levy Opbergen: perskits, foto’s, video’s en social templates. We helpen je graag met maatwerk content voor tv, print en online.
          </p>
        </section>
