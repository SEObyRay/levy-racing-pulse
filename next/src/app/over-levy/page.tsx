...
export const metadata: Metadata = {
  title: "Over Levy Opbergen",
  description:
    "Lees het verhaal, de missie en de trainingsaanpak van karttalent Levy Opbergen en ontdek zijn route naar de top.",
  openGraph: {
    title: "Over Levy Opbergen",
    description:
      "Leer meer over kartcoureur Levy Opbergen, zijn missie, trainingsaanpak en de circuits waar hij zich ontwikkelt.",
    url: "https://levyopbergen.nl/over-levy",
  },
};
...
export default function OverLevyPage() {
  return (
      ...
      <div className="container mx-auto px-4 max-w-5xl space-y-20">
        <section className="text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Levy Opbergen begon in 2025 aan zijn kartavontuur. Met een Parolin-chassis en een ID Engine 200cc Rocky motor werkt hij
            elke training aan snelheid, controle en race-intelligentie. Doel: kampioen worden in de hoogste klasses van het karting en
            uiteindelijk doorstromen naar de autosport.
          </p>
          <div className="flex justify-center gap-4">
            <Button asChild className="gradient-orange shadow-orange hover-lift">
              <Link href="/sponsors">Word partner</Link>
            </Button>
        ...
        <section className="space-y-8">
          <header className="space-y-2 text-center">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto">
              Groei komt voort uit regelmatige trainingsblokken, fysieke begeleiding en mentale voorbereiding. Levy combineert technische
              coaching met veel track time om iedere ronde sneller te worden.
            </p>
          </header>
            ...
            <Card className="h-full">
              <CardContent className="p-8 space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Techniek, starts, racepace en wedstrijdsimulaties vormen de kern van het schema. Elke sessie eindigt met data-analyse
                  zodat Levy precies weet waar hij kan verbeteren.
                </p>
              </CardContent>
            </Card>
            <Card className="h-full">
              <CardContent className="p-8 space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Voor elke race wordt een strategie opgesteld: inhaalpunten, bandenmanagement en startprocedures. Levy ontwikkelt een
                  winnaarsmentaliteit zonder het plezier in de sport te verliezen.
                </p>
              </CardContent>
            </Card>
          </div>
